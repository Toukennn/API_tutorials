...
# Base Pydantic Models -> this makes sure that the data types are correct
...
class UpdateUser(BaseModel):
    name: Optional[str] = None # it means that if we want to update it,
                               # the type should be string, otherwise 
                               # we do not do any updates
...
@app.get("/")
def root():
    return {"message": "Welcome to intoduction to FastAPI"}
